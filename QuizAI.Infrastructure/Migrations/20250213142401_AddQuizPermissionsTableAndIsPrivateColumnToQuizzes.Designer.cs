...
namespace QuizAI.Infrastructure.Migrations
{
    ...
    [Migration("20250213142401_AddQuizPermissionsTableAndIsPrivateColumnToQuizzes")]
    partial class AddQuizPermissionsTableAndIsPrivateColumnToQuizzes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizAI.Domain.Entities.QuizPermission", b =>
                {
                    b.HasOne("QuizAI.Domain.Entities.Quiz", "Quiz")
                        .WithOne("QuizPermission")
                        .HasForeignKey("QuizAI.Domain.Entities.QuizPermission", "QuizId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuizAI.Domain.Entities.User", "User")
                        .WithOne("QuizPermission")
                        .HasForeignKey("QuizAI.Domain.Entities.QuizPermission", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
