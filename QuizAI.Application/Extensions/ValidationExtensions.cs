...
public static class ValidationExtensions
{
    ...
    public static IRuleBuilderOptions<T, string> IsValidQuestionContent<T>(this IRuleBuilder<T, string> ruleBuilder)
    {
        return ruleBuilder
    ...
    public static IRuleBuilderOptions<T, ICollection<MultipleChoiceAnswerDto>> IsValidMultipleChoiceAnswers<T>(
    ...
    public static IRuleBuilderOptions<T, int> IsValidPageSize<T>(this IRuleBuilder<T, int> ruleBuilder, int[] allowPageSizes) 
        where T : IPaginationQuery
    {
        return ruleBuilder
